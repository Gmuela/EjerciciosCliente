  ...
  for (var toolid in _satellite.tools){
    if (_satellite.tools[toolid].settings.engine == "sc"){
      ...
      arrAccount = accountP.split(",");
        ...
        if(/meristation.com.mx/.test(hostn)){												// Mexico
          return arrAccount[2] + "," + arrAccount[0];
        }
        else if(/meristation.com/.test(hostn)){									    // España
...
if (typeof(country) == 'undefined') country='españa'; 
if (typeof(error) == 'undefined') error=''; 

if(/mx/.test(s.server)){									// Mexico
 		var country="mexico";
}
...
s.prop31="entretenimiento"; 																				// Temathic			
